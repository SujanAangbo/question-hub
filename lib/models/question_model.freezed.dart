...
mixin _$QuestionModel {
 ...
 String get id; List<QuestionBlockModel> get content; String get marks; String get createdAt; String get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(content),marks,createdAt,updatedAt);

@override
String toString() {
  return 'QuestionModel(id: $id, content: $content, marks: $marks, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, List<QuestionBlockModel> content, String marks, String createdAt, String updatedAt
});
...
/// Create a copy of QuestionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? content = null,Object? marks = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  List<QuestionBlockModel> content,  String marks,  String createdAt,  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuestionModel() when $default != null:
return $default(_that.id,_that.content,_that.marks,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  List<QuestionBlockModel> content,  String marks,  String createdAt,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _QuestionModel():
return $default(_that.id,_that.content,_that.marks,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  List<QuestionBlockModel> content,  String marks,  String createdAt,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _QuestionModel() when $default != null:
return $default(_that.id,_that.content,_that.marks,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _QuestionModel implements QuestionModel {
  const _QuestionModel({required this.id, required final  List<QuestionBlockModel> content, required this.marks, required this.createdAt, required this.updatedAt}): _content = content;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(_content),marks,createdAt,updatedAt);
...
/// Create a copy of QuestionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? content = null,Object? marks = null,Object? createdAt = null,Object? updatedAt = null,}) {
