...
mixin _$PyqModel {
 ...
 int get id; int get course; int get subject; QuestionModel get question; int? get batch; int get year; int get sn; int get group; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,course,subject,question,batch,year,sn,group,createdAt,updatedAt);

@override
String toString() {
  return 'PyqModel(id: $id, course: $course, subject: $subject, question: $question, batch: $batch, year: $year, sn: $sn, group: $group, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, int course, int subject, QuestionModel question, int? batch, int year, int sn, int group, String? createdAt, String? updatedAt
});
...
/// Create a copy of PyqModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? course = null,Object? subject = null,Object? question = null,Object? batch = freezed,Object? year = null,Object? sn = null,Object? group = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
$QuestionModelCopyWith<$Res> get question {
  ...
  return $QuestionModelCopyWith<$Res>(_self.question, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int course,  int subject,  QuestionModel question,  int? batch,  int year,  int sn,  int group,  String? createdAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PyqModel() when $default != null:
return $default(_that.id,_that.course,_that.subject,_that.question,_that.batch,_that.year,_that.sn,_that.group,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int course,  int subject,  QuestionModel question,  int? batch,  int year,  int sn,  int group,  String? createdAt,  String? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PyqModel():
return $default(_that.id,_that.course,_that.subject,_that.question,_that.batch,_that.year,_that.sn,_that.group,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int course,  int subject,  QuestionModel question,  int? batch,  int year,  int sn,  int group,  String? createdAt,  String? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PyqModel() when $default != null:
return $default(_that.id,_that.course,_that.subject,_that.question,_that.batch,_that.year,_that.sn,_that.group,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PyqModel implements PyqModel {
  const _PyqModel({required this.id, required this.course, required this.subject, required this.question, this.batch, required this.year, required this.sn, required this.group, this.createdAt, this.updatedAt});
...
@override final  QuestionModel question;
...
@override $QuestionModelCopyWith<$Res> get question;
...
/// Create a copy of PyqModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? course = null,Object? subject = null,Object? question = null,Object? batch = freezed,Object? year = null,Object? sn = null,Object? group = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
